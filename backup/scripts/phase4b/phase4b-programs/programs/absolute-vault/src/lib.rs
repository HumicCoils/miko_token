...
declare_id!("9qPiWoJJdas55cMZqa8d62tVHP9hbYX6NwT34qbHe9pt");
...
pub mod absolute_vault {
    ...
    pub fn withdraw_fees_from_mint(ctx: Context<WithdrawFeesFromMint>) -> Result<()> {
        ...
        // Create instruction to withdraw all withheld fees from mint to vault token account
        ...
        msg!("Withdrew fees from mint to vault token account");
